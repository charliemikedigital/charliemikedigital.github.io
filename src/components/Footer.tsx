...
// GitHub icon isn't in this version of lucide-react; inline the SVG ourselves.
// Mirrors the lucide component API (accepts size/strokeWidth via props).
...
const ICON_LINKS: Array<{ label: string; href: string; icon: ComponentType<SVGProps<SVGSVGElement>> }> = [
  ...
  { label: 'Phone', href: 'tel:+12815550847', icon: Phone },
  { label: 'GitHub', href: 'https://github.com/charliemikedigital', icon: GithubIcon },
];
